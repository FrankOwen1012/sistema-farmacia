...
export const Registrar = () => {
    ...
    const botonGuardar = (e) => {
        ...
        setRegistrologin([...registroslogin, miObjeto]);

        limpiarFormulario();

    }

    useEffect(() => {//apuntando al localStorage
            ...
            <div className="h3">
                ...
                <form id="miFormulario"  >
                    ...
                    <div className="row" style={{ marginTop: 20 }}>
                        ...
                        <div className="col-6">
                            <input className="form-control form-control-lg text-center" type="number" min="1" max="100000000"
                                placeholder="Digite El Precio" onChange={(e) => setPrecio(e.target.value)} required />
                        </div>
                    </div>
